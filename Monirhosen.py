...
\033[1;91m┗━━━┛ \033[1;92m┗━━┛ \033[1;93m┗┛︱┗━┛ \033[1;94m︱︱┗┛︱︱ \033[1;99m┗┛︱┗┛ \033[1;95m┗┛┗┛┗┛ \033[1;96m┗━━┛ \033[1;97m┗┛︱┗━┛
\033[1;31m\033[1;31m╔══════════════════════════════════════════════════╗
\033[1;31m\033[1;31m║\033[0;33m\033[1;33m* AUTHOR  : -//- Monir Hosen -//-  ║
\033[1;31m\033[1;31m║\033[0;33m\033[1;33m* Facebook Page : its.monir.uz.zama1║
\033[1;31m\033[1;31m║\033[0;33m\033[1;33m* youtube : https://youtube.com/channel/UCOIy5igzyh453gGQChVsOtQ ║
\033[1;31m\033[1;31m╚══════════════════════════════════════════════════╝"""
...
└────────────────────────────────────────────────────────┘
"""
print "\033[1;96m•◈•───────────────•◈•\033[1;92 MONIR♡HOSEN\033[1;96m•◈•───────────────•◈•"
jalan("    \033[1;93m┳┻┳┻▇▇▇▇▇▇     ╭━━━━╮╱▔▔▔╲      ▇▇▇▇▇▇┳┻┳┻┳┻")
jalan("    \033[1;93m┻┳┻┳▇▇▇▇▇▇     ┃╯╯╭━┫▏╰╰╰▕      ▇▇▇▇▇▇┻┳┻┳┻┳")
jalan("    \033[1;93m┳┻┳┻▇▇▇▇▇▇     ┃╯╯┃▔╰┓▔▂▔▕╮     ▇▇▇▇▇▇┳┻┳┻┳┻")
jalan("    \033[1;93m┻┳┻┳▇▇▇▇▇▇     ╰╮╯┃┈╰┫╰━╯┏╯     ▇▇▇▇▇▇┻┳┻┳┻┳")
...
jalan("    \033[1;93m┻┳┻┳▇▇▇▇▇▇     ┏╯▔'''╰┓┣━┳┫     ▇▇▇▇▇▇┳┻┳┻┳┻")
jalan("    \033[1;93m ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇")
jalan("    \033[1;93m▇▇\033[1;95m           WellCome to Monir Hosen      \033[1;93m▇▇")
jalan("    \033[1;93m▇▇\033[1;91m              👇  AUTHOR  👇          \033[1;93m▇▇")
jalan("    \033[1;93m▇▇\033[1;92m          This Tools Is Created By    \033[1;93m▇▇")
jalan("    \033[1;93m▇▇\033[1;92m                Monir Hosen           \033[1;93m▇▇")
jalan("    \033[1;93m▇▇\033[1;92m       YOUTUBE   Xudi Tricks Bangla   \033[1;93m▇▇")
jalan("    \033[1;93m ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇")

CorrectUsername = "MONIR "
CorrectPassword = " hosen "
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://youtube.com/channel/UCOIy5igzyh453gGQChVsOtQ')
    else:
        print "Wrong Dear!"
        os.system('xdg-open https://youtube.com/channel/UCOIy5igzyh453gGQChVsOtQ')
...
def menu():
	...
	os.system("clear") #Dev:binyamin
        time.sleep(0.05)
	print logo
	print "\033[1;96m•◈•───────────────•◈•\033[1;72 Monir♤Hosen\033[1;96m•◈•───────────────•◈•"
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;96m•◈•───────────────•◈•\033[1;92mMonir♤Hosen\033[1;96m•◈•───────────────•◈•"
